...
if __name__ == '__main__':
	...
	# algorithms['ThompsonSamplingLinearBandit'] = ThompsonSamplingLinearBandit(dimension=context_dimension, lambda_=0.1)
	# algorithms['ThompsonSamplingMultiArmedBandit'] = ThompsonSamplingMultiArmedBandit(num_arm=n_articles)
	# algorithms['LinUCB'] = LinUCB(dimension=context_dimension, lambda_=0.1, alpha=0.1)
	# algorithms['LinTS'] = LinTS(dimension=context_dimension, lambda_=0.1, alpha=0.1)
	algorithms['UCB'] = UCB(dimension=context_dimension)
